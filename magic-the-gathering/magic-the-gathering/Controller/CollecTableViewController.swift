...
class TableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        //API Deezer
                ...
                let url = URL(string: "https://api.magicthegathering.io/v1/cards?name=Avacyn")!
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            if let vc = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(identifier: "webview") as? CollecWebViewController {
